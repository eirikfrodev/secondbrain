...
Additional package instructions:

- Read `specs/README.md` and use its fixtures as the first domain test cases.
- Preserve `HANDOFF.md` as canonical; do not rewrite it to match implementation shortcuts.
- The empty implementation directories are intentional. Scaffold into them.
- Before external integrations, demonstrate the complete mock lifecycle in the browser.
- Record each material deviation as an ADR in `docs/architecture-decisions.md`.
