...
| R-02 | A visually presented action is treated as execution authority. | medium | high | Documents carry IDs only; actions are separately validated against capability, risk, revision, expiry, account, and idempotency before approval. Phase 1 never performs external effects. | Domain/actions, all phases |
